...
### `POST /api/admin/strm/generate` (`src/routes/contentmanager.ts`, pre-existing)
...
- `src/utils/strmGenerator.ts` — generation logic + concurrency guard (see [[skill-content-manager]])
